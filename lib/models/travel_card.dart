class TravelCard {
  ...
  static final List<TravelCard> fakeTravelCardList = [
    TravelCard(
      ...
      image: "assets/images/card/croatia.jpg",
      description:
    ...
    TravelCard(
      contry: "Singapore",
      title: "Singapore",
      image: "assets/images/card/singapore.jpg",
      description:
    ...
    TravelCard(
      contry: "Armenia",
      title: "Armenia",
      image: "assets/images/card/armenia.jpg",
      description:
    ...
    TravelCard(
      ...
      image: "assets/images/card/italy.jpg",
      description:
    ...
    TravelCard(
      ...
      title: "Ilkley Moor",
      image: "assets/images/card/uk.jpg",
      description:
    ...
    TravelCard(
      contry: "Vietnam",
      title: "Tokyo",
      image: "assets/images/card/vietnam.jpg",
      description:
