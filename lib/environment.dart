...
class Environment {
  ...
  static const String customUriScheme = String.fromEnvironment(
      "CUSTOM_URI_SCHEME",
      defaultValue: "com.niula.firstflutterapp");

  static const String redirectUrlGithubApp = String.fromEnvironment(
      "REDIRECTURL_GITHUB_APP",
      defaultValue: "com.niula.firstflutterapp://oauthredirect");
  ...
  static const String clientIdGoogleApp = String.fromEnvironment(
      "CLIENTID_GOOGLE_APP",
      defaultValue:
          "1050243788749-5ld1o3roohog2anjorj30vt29t0cu3d4.apps.googleusercontent.com");
